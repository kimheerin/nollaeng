		...
		<div id="content">
			...
			<ul class="prod-list">
				...
				<li><img src="../resources/images/bg2광진.png" alt="상품2">
					<div class="caption">
						<a href="../instar/instar.jsp"><h2>상품 2</h2></a>
						<p>상품 2 설명 텍스트</p>
						<p>가격: 30,000원</p>
					</div></li>
				<li><img src="../resources/images/bg3.jpg" alt="상품3">
					<div class="caption">
						<a href="../instar/instar.jsp"><h2>상품 3</h2></a>
						<p>상품 3 설명 텍스트</p>
						<p>가격: 30,000원</p>
					</div></li>
				<li><img src="../resources/images/낙산.jpg" alt="상품3">
					<div class="caption">
						<a href="../instar/instar.jsp"><h2>상품 4</h2></a>
						<p>상품 3 설명 텍스트</p>
						<p>가격: 30,000원</p>
					</div></li>
				<li><img src="../resources/images/여의도한강.jpg" alt="상품3">
					<div class="caption">
						<a href="../instar/instar.jsp"><h2>상품 5</h2></a>
						<p>상품 3 설명 텍스트</p>
						<p>가격: 30,000원</p>
					</div></li>
				<li><img src="../resources/images/한강.jpg" alt="상품3">
					<div class="caption">
						<a href="../instar/instar.jsp"><h2>상품 6</h2></a>
						<p>상품 3 설명 텍스트</p>
						<p>가격: 30,000원</p>
					</div></li>
